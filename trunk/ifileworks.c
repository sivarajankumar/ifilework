 ...
 */
    ...
    */   
    ...
    {   
            ...
            if (ifw_cur_user && space) {   
                    if (strlen(ifw_cur_user->pass) == 0 ||   
                            strcmp(space + 1, ifw_cur_user->pass) == 0) {   
                            IFW_DEBUG("password for %s OK\n", ifw_cur_user->user);   
                            return ifw_send_resp(ctrlfd, 230, ifw_cur_user->user);   
                    }   
